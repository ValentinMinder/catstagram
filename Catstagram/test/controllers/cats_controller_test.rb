...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { birth_time: @cat.birth_time, catname: @cat.catname, city: @cat.city, description: @cat.description }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { birth_time: @cat.birth_time, catname: @cat.catname, city: @cat.city, description: @cat.description }
    assert_redirected_to cat_path(assigns(:cat))
  end
